...
urlpatterns = [
    ...
    path("client/setphoto", views.updateUserPhoto, name="set-client-photo"),
 ...
 path("admin/add", views.createAdmin, name="add-admin"),
    ...
    path("admin/setphoto", views.updateUserPhoto, name="set-admin-photo"),
   ...
   path("superadmin/add", views.createSuperadmin, name="add-superadmin"),
    ...
    path("superadmin/setphoto", views.updateUserPhoto, name="set-superadmin-photo"),
 ...
 path("entite/add", views.createEntite, name="add-entite"),
    ...
    path("entite/setphoto", views.updateUserPhoto, name="set-entite-photo"),
